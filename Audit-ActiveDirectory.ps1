...
.PARAMETER RightLogo
    ...
    -RightLogo "https://virtechsystems.com/wp-content/uploads/2022/04/Asset-3.png"
...
param (
	...
	[String]$RightLogo = "https://virtechsystems.com/wp-content/uploads/2022/04/Asset-3.png",
	...
	[Parameter(ValueFromPipeline = $true, HelpMessage = "Enter desired directory path to save; Default: C:\Windows\Temp\ADAudit")]
	[String]$ReportSavePath = "C:\Windows\Temp\ADAudit",
